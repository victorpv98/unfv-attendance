    ...
    <div class="flex-1 overflow-y-auto py-4">
        <nav class="px-2 space-y-1">
            ...
            @elseif(Auth::user()->role === 'student')
                ...
                <a href="{{ route('students.my-barcode') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md {{ request()->routeIs('students.my-barcode') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                    <!-- Icono de código de barras -->
                    <svg class="mr-3 h-6 w-6 {{ request()->routeIs('students.my-barcode') ? 'text-gray-300' : 'text-gray-400 group-hover:text-gray-300' }}" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
