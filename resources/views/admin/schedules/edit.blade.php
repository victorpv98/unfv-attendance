...
<div class="card shadow border-0 mb-4">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 fw-bold text-primary">Editar Horario</h6>
        ...
        <form action="{{ route('admin.schedules.update', $schedule) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('classroom') is-invalid @enderror" 
                    id="classroom" name="classroom" value="{{ old('classroom', $schedule->classroom) }}" required>
                @error('classroom')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('semester') is-invalid @enderror" 
                    id="semester" name="semester" value="{{ old('semester', $schedule->semester) }}" required placeholder="Ejemplo: 2025-I">
                @error('semester')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="d-flex justify-content-end mt-4">
                <a href="{{ route('admin.schedules.index') }}" class="btn btn-outline-secondary me-2">Cancelar</a>
